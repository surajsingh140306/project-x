    ...
    >
      <header className="space-y-1" data-testid="home-header">
        <h1 className="text-xl font-semibold tracking-tight text-slate-50">
          project-x <span className="text-slate-400">· AI Coding Playground (Skeleton)</span>
        </h1>
        <p className="text-sm text-slate-400 max-w-2xl">
          Enter a prompt and hit "Test Generate" to call the /api/generate endpoint. When configured
          with AI_PROVIDER=gemini, this will use Gemini 1.5 Flash via REST API.
        </p>
      </header>
